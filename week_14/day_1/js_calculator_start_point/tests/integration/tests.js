...
describe('calculator functionality', function() {
 ...
 it(‘should be able to multiply 4 * 5’, function(){
    running_total = element(by.css(‘#running_total’))
 ...
 it(‘should be able to divide 18 by 6’, function(){
   running_total = element(by.css(‘#running_total’))
 ...
 it(‘should be able to add 2 + 5’, function(){
    running_total = element(by.css(‘#running_total’))
    element(by.css(‘#number2’)).click();
 ...
 t(‘should be able to subtract 8 - 4’, function(){
    running_total = element(by.css(‘#running_total’))
    element(by.css(‘#number8’)).click();
